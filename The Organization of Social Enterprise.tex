...
Anticipating \lemref{lem:measure-if-transact}, I write the entrepreneur's
problem in reduced form. The lemma proves that no optimum contains an
unmeasured transaction, because the entrepreneur weakly prefers to assist
such a beneficiary through giving. Thus, in the reduced problem, the
entrepreneur measures every beneficiary with whom the firm transacts
and incurs $C(m)$. No separate measurement choice is therefore required.
