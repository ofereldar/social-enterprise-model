...
incentive therefore ensures that certified transactions are measured and
tailored even when $\gamma=0$. \propref{prop:certification} maintains $\gamma>0$ for the
stronger conclusion that the entrepreneur undertakes no additional untailored
giving and therefore attains maximal quality overall.
...
Certification can relax the scaling problem when donors cannot infer quality
from planned scale. Certifiers need not assess impact directly. By verifying
beneficiary transactions, they make the information-generating activity
contractible and can support expansion without sacrificing targeting quality.
Support tied to verified transactions may therefore be more effective than
broad subsidies that reward scale alone.
