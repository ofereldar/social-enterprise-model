...
as a disbursal departs from the beneficiary's need.\footnote{\secref{oa:no-penalty} of the Online Appendix discusses a quality measure with no penalty for waste. The conclusion discusses the case in which quality is defined by quantity.}
...
\secref{subsec:transacting-giving}), I omit a separate measurement choice.
The lemma proves that no optimum exists in which the entrepreneur chooses
to transact with beneficiaries but does not incur measurement costs to
learn their abilities. Without measurement, she cannot tailor disbursals
to ability, which lowers targeting quality and can also reduce net profits
through inadequate assistance or waste. This result allows me to write
the entrepreneur's expected-utility problem in a more tractable form.
In the problem below, choosing $m$ means that the entrepreneur incurs
$C(m)$, the cost of measuring the abilities of all $m$ beneficiaries
with whom the firm transacts.
