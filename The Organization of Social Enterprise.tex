...
$\gamma$ approaches zero. \propref{prop:certification} assumes $\gamma>0$
and therefore also rules out additional untailored giving, guaranteeing
maximal overall quality.
...
guarantee maximal targeting quality.
\end{prop}
