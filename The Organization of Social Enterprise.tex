...
chooses to incur $C(m)$ to observe each beneficiary's ability, $a(i)$,
and tailor the beneficiary's disbursal to that ability (such that
$d^{m}(i)=\bar{a}-a(i)$).
...
Anticipating \lemref{lem:measure-if-transact} (discussed in
\secref{subsec:transacting-giving}), I write the entrepreneur's problem
without a separate measurement choice. The lemma proves that no optimum
exists in which the entrepreneur chooses to transact with beneficiaries
but does not incur measurement costs to learn their abilities. Without
measurement, she cannot tailor disbursals to ability, which lowers targeting
quality and can also reduce net profits through inadequate assistance
or waste. Accordingly, in the problem below, the entrepreneur measures
every beneficiary with whom the firm transacts and incurs $C(m)$.
...
The model's central alignment is now immediate. For a beneficiary the
