...
or a nonprofit organization. Beneficiaries may be defined by income, unemployment status, geographic
...
baseline assumptions, including no nonprofit tax advantage, the entrepreneur
chooses the for-profit. This result survives when donors care about expected
quality. It helps explain why
...
When heterogeneity is lower and some giving remains, the nonprofit may provide
higher targeting quality. Donors who adjust funding for expected quality may
then tilt the entrepreneur toward the nonprofit, but need not do so. The model
therefore does not yield a single prediction for legal form or scale in
settings where tailoring is less important.

When donors cannot infer quality from planned scale, transaction certification
can relax the scaling problem without direct impact assessment. It makes the
information-generating activity contractible, allowing expansion without
