...
with $D_v(0)=0$, the fact that the donor's marginal condition is the same
under both legal forms implies equal support at $\widehat n$.
...
estimate expected quality and adjust their funding accordingly. Because the
nonprofit may provide higher expected quality in this region, this adjustment
can tilt the entrepreneur toward the nonprofit, but need not do so. Either
legal form may therefore be chosen. This case is less central to the paper's
