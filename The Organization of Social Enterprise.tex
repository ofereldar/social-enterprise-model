...
\lemref{lem:measure-if-transact}, proved in
\secref{subsec:transacting-giving}, shows that an entrepreneur who transacts
with beneficiaries always chooses to incur $C(m)$, observe each beneficiary's
ability $a(i)$, and tailor the beneficiary's disbursal to that ability
(such that $d^{m}(i)=\bar{a}-a(i)$). This result allows me to omit a
separate measurement choice from the entrepreneur's optimization problem.
Accordingly, whenever the entrepreneur chooses $m$, she incurs $C(m)$,
the cost of measuring the abilities of all $m$ beneficiaries with whom
the firm transacts.
