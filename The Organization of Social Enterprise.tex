...
is the ability of a standard worker. The amount of assistance needed
to raise beneficiary $i$ to the standard-worker level is therefore
$\bar{a}-a(i)$. Abilities are drawn from a distribution with mean $\mathbb{E}(a)$
...
tailored disbursal for beneficiary $i$ is $\bar{a}-a(i)$. A lower
disbursal leaves the beneficiary below $\bar{a}$; a higher disbursal
is wasteful. If the firm employs only standard workers,
...
\[
q=-\int_{0}^{n}\left(d(i)-(\bar{a}-a(i))\right)^{2}di.
\]
